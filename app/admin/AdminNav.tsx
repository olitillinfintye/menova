...
import { BarChart3, Box, Inbox, LogOut, ArrowUpRight, PanelsTopLeft, UserRound, Video } from "lucide-react";

const links = [
  { href: "/admin", label: "Analytics", icon: BarChart3 },
  { href: "/admin/models", label: "Models", icon: Box },
  { href: "/admin/homepage", label: "Homepage", icon: PanelsTopLeft },
...
export function AdminNav() {
  ...
  return (
    <header className="border-b border-[var(--color-line)] bg-[var(--color-surface)]">
      ...
      <nav aria-label="Admin navigation" className="mx-auto grid max-w-7xl grid-cols-2 gap-1 px-5 min-[400px]:grid-cols-3 sm:flex sm:gap-2 sm:px-8">
