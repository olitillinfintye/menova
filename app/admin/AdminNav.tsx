...
import { BarChart3, Box, Inbox, LogOut, ArrowUpRight, UserRound } from "lucide-react";
...
export function AdminNav() {
  ...
  return (
    <header className="border-b border-[var(--color-line)] bg-[var(--color-surface)]">
      ...
      <nav aria-label="Admin navigation" className="mx-auto grid max-w-7xl grid-cols-3 gap-1 px-5 sm:flex sm:gap-2 sm:px-8">
